                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Sign in to continue to Aplikasi Pelaporan Safety Perusahaan.</p>
                                    </div>
                                </div>
                                ...
                                <form class="form-horizontal" action="login" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="username" class="form-control" name="username" id="email"
                                            @if(old('username')) value="{{ old('username') }}" @else value="" @endif
                                            autofocus>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" class="form-control" name="password" id="password"
                                                ...
                                                aria-describedby="password-addon" autocomplete="current-password">
